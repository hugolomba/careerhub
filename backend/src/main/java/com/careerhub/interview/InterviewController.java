...
public class InterviewController {
    ...
    // Flat list across all of the user's applications, for the standalone Interviews page.
    ...
    // Update and delete do not require the applicationId in the URL, as the interview ID alone is sufficient.
