  ...
  return (
    <div className="grid min-h-screen lg:grid-cols-2">
      <BrandPanel
        ...
        subheading="Pick up right where you left off — your applications, interviews and CVs are all waiting for you."
      />
      ...
      <div className="flex min-h-screen items-center justify-center bg-slate-50 px-4 py-12">
        <div className="w-full max-w-sm">
          <div className="mb-8 flex flex-col items-center lg:items-start">
            ...
            <h1 className="text-2xl font-bold text-slate-900">Log in to CareerHub</h1>
            <p className="mt-1 text-sm text-slate-500">Glad to see you again.</p>
          </div>
